...
//     np->trapframe->a0 = 0; // Clear fork return value for child

//     // Set process state
//     safestrcpy(np->name, filename, sizeof(np->name));
//     np->parent = p;
//     np->state = RUNNABLE;

//     // Execute the specified file
//     if (exec(filename, 0) < 0) {
//         freeproc(np); // Clean up if exec fails
//         return -1;
//     }

//     return np->pid; // Return new process ID
// }
