...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      c4:	14050513          	addi	a0,a0,320 # 1200 <malloc+0xf6>
      c8:	3c1000ef          	jal	c88 <mkdir>
  if(chdir("grindir") != 0){
      cc:	00001517          	auipc	a0,0x1
      d0:	13450513          	addi	a0,a0,308 # 1200 <malloc+0xf6>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      f2:	11a50513          	addi	a0,a0,282 # 1208 <malloc+0xfe>
      f6:	75d000ef          	jal	1052 <printf>
    exit(1);
      fa:	4505                	li	a0,1
  ...
  chdir("/");
     ...
     118:	11c50513          	addi	a0,a0,284 # 1230 <malloc+0x126>
     11c:	375000ef          	jal	c90 <chdir>
     120:	00001c17          	auipc	s8,0x1
     124:	120c0c13          	addi	s8,s8,288 # 1240 <malloc+0x136>
     128:	c489                	beqz	s1,132 <go+0x88>
     12a:	00001c17          	auipc	s8,0x1
     12e:	10ec0c13          	addi	s8,s8,270 # 1238 <malloc+0x12e>
  uint64 iters = 0;
     132:	4481                	li	s1,0
  int fd = -1;
     134:	5cfd                	li	s9,-1
  ...
  while(1){
    ...
    int what = rand() % 23;
     ...
     15e:	3b690913          	addi	s2,s2,950 # 1510 <malloc+0x406>
      close(fd1);
      unlink("c");
    } else if(what == 22){
      // echo hi | cat
     ...
     170:	0dc50513          	addi	a0,a0,220 # 1248 <malloc+0x13e>
    ...
    int what = rand() % 23;
     ...
     240:	03c50513          	addi	a0,a0,60 # 1278 <malloc+0x16e>
     ...
     25a:	03250513          	addi	a0,a0,50 # 1288 <malloc+0x17e>
     ...
     348:	fcc50513          	addi	a0,a0,-52 # 1310 <malloc+0x206>
     34c:	507000ef          	jal	1052 <printf>
        exit(1);
     350:	4505                	li	a0,1
     ...
     37a:	f9a50513          	addi	a0,a0,-102 # 1310 <malloc+0x206>
     37e:	4d5000ef          	jal	1052 <printf>
        exit(1);
     382:	4505                	li	a0,1
     384:	09d000ef          	jal	c20 <exit>
      sbrk(6011);
     388:	6505                	lui	a0,0x1
     38a:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x20b>
     ...
     3c6:	f6e50513          	addi	a0,a0,-146 # 1330 <malloc+0x226>
     ...
     3e6:	f4650513          	addi	a0,a0,-186 # 1328 <malloc+0x21e>
     ...
     3fc:	f1850513          	addi	a0,a0,-232 # 1310 <malloc+0x206>
     400:	453000ef          	jal	1052 <printf>
        exit(1);
     404:	4505                	li	a0,1
     406:	01b000ef          	jal	c20 <exit>
        printf("grind: chdir failed\n");
     40a:	00001517          	auipc	a0,0x1
     40e:	f3650513          	addi	a0,a0,-202 # 1340 <malloc+0x236>
     412:	441000ef          	jal	1052 <printf>
        exit(1);
     416:	4505                	li	a0,1
     ...
     440:	ed450513          	addi	a0,a0,-300 # 1310 <malloc+0x206>
     444:	40f000ef          	jal	1052 <printf>
        exit(1);
     448:	4505                	li	a0,1
     ...
     480:	edc50513          	addi	a0,a0,-292 # 1358 <malloc+0x24e>
     484:	3cf000ef          	jal	1052 <printf>
        exit(1);
     488:	4505                	li	a0,1
     ...
     49c:	ed858593          	addi	a1,a1,-296 # 1370 <malloc+0x266>
     ...
     4cc:	eb050513          	addi	a0,a0,-336 # 1378 <malloc+0x26e>
     4d0:	383000ef          	jal	1052 <printf>
     4d4:	bfe9                	j	4ae <go+0x404>
          printf("grind: pipe read failed\n");
     4d6:	00001517          	auipc	a0,0x1
     4da:	ec250513          	addi	a0,a0,-318 # 1398 <malloc+0x28e>
     4de:	375000ef          	jal	1052 <printf>
     4e2:	b7c5                	j	4c2 <go+0x418>
        printf("grind: fork failed\n");
     4e4:	00001517          	auipc	a0,0x1
     4e8:	e2c50513          	addi	a0,a0,-468 # 1310 <malloc+0x206>
     4ec:	367000ef          	jal	1052 <printf>
        exit(1);
     4f0:	4505                	li	a0,1
     ...
     55e:	db650513          	addi	a0,a0,-586 # 1310 <malloc+0x206>
     562:	2f1000ef          	jal	1052 <printf>
        exit(1);
     566:	4505                	li	a0,1
     568:	6b8000ef          	jal	c20 <exit>
      unlink("c");
     56c:	00001517          	auipc	a0,0x1
     570:	e5450513          	addi	a0,a0,-428 # 13c0 <malloc+0x2b6>
     574:	6fc000ef          	jal	c70 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     578:	20200593          	li	a1,514
     57c:	00001517          	auipc	a0,0x1
     580:	e4450513          	addi	a0,a0,-444 # 13c0 <malloc+0x2b6>
     ...
     594:	de058593          	addi	a1,a1,-544 # 1370 <malloc+0x266>
     ...
     5ca:	dfa50513          	addi	a0,a0,-518 # 13c0 <malloc+0x2b6>
     5ce:	6a2000ef          	jal	c70 <unlink>
     5d2:	b66d                	j	17c <go+0xd2>
        printf("grind: create c failed\n");
     5d4:	00001517          	auipc	a0,0x1
     5d8:	df450513          	addi	a0,a0,-524 # 13c8 <malloc+0x2be>
     5dc:	277000ef          	jal	1052 <printf>
        exit(1);
     5e0:	4505                	li	a0,1
     5e2:	63e000ef          	jal	c20 <exit>
        printf("grind: write c failed\n");
     5e6:	00001517          	auipc	a0,0x1
     5ea:	dfa50513          	addi	a0,a0,-518 # 13e0 <malloc+0x2d6>
     5ee:	265000ef          	jal	1052 <printf>
        exit(1);
     5f2:	4505                	li	a0,1
     5f4:	62c000ef          	jal	c20 <exit>
        printf("grind: fstat failed\n");
     5f8:	00001517          	auipc	a0,0x1
     5fc:	e0050513          	addi	a0,a0,-512 # 13f8 <malloc+0x2ee>
     600:	253000ef          	jal	1052 <printf>
        exit(1);
     604:	4505                	li	a0,1
     ...
     610:	e0450513          	addi	a0,a0,-508 # 1410 <malloc+0x306>
     614:	23f000ef          	jal	1052 <printf>
        exit(1);
     618:	4505                	li	a0,1
     61a:	606000ef          	jal	c20 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     61e:	00001517          	auipc	a0,0x1
     622:	e1a50513          	addi	a0,a0,-486 # 1438 <malloc+0x32e>
     626:	22d000ef          	jal	1052 <printf>
        exit(1);
     62a:	4505                	li	a0,1
     ...
     6d4:	e0858593          	addi	a1,a1,-504 # 14d8 <malloc+0x3ce>
     ...
     6ea:	c7258593          	addi	a1,a1,-910 # 1358 <malloc+0x24e>
     6ee:	4509                	li	a0,2
     6f0:	139000ef          	jal	1028 <fprintf>
        exit(1);
     6f4:	4505                	li	a0,1
     6f6:	52a000ef          	jal	c20 <exit>
        fprintf(2, "grind: pipe failed\n");
     6fa:	00001597          	auipc	a1,0x1
     6fe:	c5e58593          	addi	a1,a1,-930 # 1358 <malloc+0x24e>
     702:	4509                	li	a0,2
     704:	125000ef          	jal	1028 <fprintf>
        exit(1);
     708:	4505                	li	a0,1
     ...
     73e:	d2658593          	addi	a1,a1,-730 # 1460 <malloc+0x356>
     742:	4509                	li	a0,2
     744:	0e5000ef          	jal	1028 <fprintf>
          exit(1);
     748:	4505                	li	a0,1
     ...
     75a:	d2278793          	addi	a5,a5,-734 # 1478 <malloc+0x36e>
     75e:	f6f43c23          	sd	a5,-136(s0)
     762:	00001797          	auipc	a5,0x1
     766:	d1e78793          	addi	a5,a5,-738 # 1480 <malloc+0x376>
     76a:	f8f43023          	sd	a5,-128(s0)
     76e:	f8043423          	sd	zero,-120(s0)
        exec("grindir/../echo", args);
     772:	f7840593          	addi	a1,s0,-136
     776:	00001517          	auipc	a0,0x1
     77a:	d1250513          	addi	a0,a0,-750 # 1488 <malloc+0x37e>
     77e:	4da000ef          	jal	c58 <exec>
        fprintf(2, "grind: echo: not found\n");
     782:	00001597          	auipc	a1,0x1
     786:	d1658593          	addi	a1,a1,-746 # 1498 <malloc+0x38e>
     78a:	4509                	li	a0,2
     78c:	09d000ef          	jal	1028 <fprintf>
        exit(2);
     790:	4509                	li	a0,2
     792:	48e000ef          	jal	c20 <exit>
        fprintf(2, "grind: fork failed\n");
     796:	00001597          	auipc	a1,0x1
     79a:	b7a58593          	addi	a1,a1,-1158 # 1310 <malloc+0x206>
     79e:	4509                	li	a0,2
     7a0:	089000ef          	jal	1028 <fprintf>
        exit(3);
     7a4:	450d                	li	a0,3
     ...
     7ce:	c9658593          	addi	a1,a1,-874 # 1460 <malloc+0x356>
     7d2:	4509                	li	a0,2
     7d4:	055000ef          	jal	1028 <fprintf>
          exit(4);
     7d8:	4511                	li	a0,4
     ...
     7fe:	c6658593          	addi	a1,a1,-922 # 1460 <malloc+0x356>
     802:	4509                	li	a0,2
     804:	025000ef          	jal	1028 <fprintf>
          exit(5);
     808:	4515                	li	a0,5
     ...
     81a:	c9a78793          	addi	a5,a5,-870 # 14b0 <malloc+0x3a6>
     81e:	f6f43c23          	sd	a5,-136(s0)
     822:	f8043023          	sd	zero,-128(s0)
        exec("/cat", args);
     826:	f7840593          	addi	a1,s0,-136
     82a:	00001517          	auipc	a0,0x1
     82e:	c8e50513          	addi	a0,a0,-882 # 14b8 <malloc+0x3ae>
     832:	426000ef          	jal	c58 <exec>
        fprintf(2, "grind: cat: not found\n");
     836:	00001597          	auipc	a1,0x1
     83a:	c8a58593          	addi	a1,a1,-886 # 14c0 <malloc+0x3b6>
     83e:	4509                	li	a0,2
     840:	7e8000ef          	jal	1028 <fprintf>
        exit(6);
     844:	4519                	li	a0,6
     846:	3da000ef          	jal	c20 <exit>
        fprintf(2, "grind: fork failed\n");
     84a:	00001597          	auipc	a1,0x1
     84e:	ac658593          	addi	a1,a1,-1338 # 1310 <malloc+0x206>
     852:	4509                	li	a0,2
     854:	7d4000ef          	jal	1028 <fprintf>
        exit(7);
     858:	451d                	li	a0,7
     ...
     86e:	c7650513          	addi	a0,a0,-906 # 14e0 <malloc+0x3d6>
     872:	7e0000ef          	jal	1052 <printf>
        exit(1);
     876:	4505                	li	a0,1
...
iter()
{
  ...
  unlink("a");
     ...
     888:	aa450513          	addi	a0,a0,-1372 # 1328 <malloc+0x21e>
     88c:	3e4000ef          	jal	c70 <unlink>
  unlink("b");
     890:	00001517          	auipc	a0,0x1
     894:	a4850513          	addi	a0,a0,-1464 # 12d8 <malloc+0x1ce>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     8ca:	a4a50513          	addi	a0,a0,-1462 # 1310 <malloc+0x206>
     8ce:	784000ef          	jal	1052 <printf>
    exit(1);
     8d2:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     8ee:	629c                	ld	a5,0(a3)
     8f0:	6709                	lui	a4,0x2
     8f2:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x699>
    ...
    printf("grind: fork failed\n");
     ...
     904:	a1050513          	addi	a0,a0,-1520 # 1310 <malloc+0x206>
     908:	74a000ef          	jal	1052 <printf>
    exit(1);
     90c:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     d14:	f426                	sd	s1,40(sp)
     d16:	f04a                	sd	s2,32(sp)
     d18:	ec4e                	sd	s3,24(sp)
     d1a:	0080                	addi	s0,sp,64
     d1c:	892a                	mv	s2,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d1e:	c299                	beqz	a3,d24 <printint+0x16>
     d20:	0605ce63          	bltz	a1,d9c <printint+0x8e>
  neg = 0;
     d24:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
     d2e:	00001817          	auipc	a6,0x1
     d32:	84280813          	addi	a6,a6,-1982 # 1570 <digits>
     d36:	88be                	mv	a7,a5
     d38:	0017851b          	addiw	a0,a5,1
     d3c:	87aa                	mv	a5,a0
     d3e:	02c5f73b          	remuw	a4,a1,a2
     d42:	1702                	slli	a4,a4,0x20
     d44:	9301                	srli	a4,a4,0x20
     d46:	9742                	add	a4,a4,a6
     d48:	00074703          	lbu	a4,0(a4)
     d4c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d50:	872e                	mv	a4,a1
     d52:	02c5d5bb          	divuw	a1,a1,a2
     d56:	0685                	addi	a3,a3,1
     d58:	fcc77fe3          	bgeu	a4,a2,d36 <printint+0x28>
  if(neg)
     d5c:	000e0c63          	beqz	t3,d74 <printint+0x66>
    buf[i++] = '-';
     d60:	fd050793          	addi	a5,a0,-48
     d64:	00878533          	add	a0,a5,s0
     d68:	02d00793          	li	a5,45
     d6c:	fef50823          	sb	a5,-16(a0)
     d70:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
     d74:	fff7899b          	addiw	s3,a5,-1
     d78:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
     d7c:	fff4c583          	lbu	a1,-1(s1)
     d80:	854a                	mv	a0,s2
     d82:	f6fff0ef          	jal	cf0 <putc>
  while(--i >= 0)
     d86:	39fd                	addiw	s3,s3,-1
     d88:	14fd                	addi	s1,s1,-1
     d8a:	fe09d9e3          	bgez	s3,d7c <printint+0x6e>
}
     d8e:	70e2                	ld	ra,56(sp)
     d90:	7442                	ld	s0,48(sp)
     d92:	74a2                	ld	s1,40(sp)
     d94:	7902                	ld	s2,32(sp)
     d96:	69e2                	ld	s3,24(sp)
     d98:	6121                	addi	sp,sp,64
     d9a:	8082                	ret
    x = -xx;
     d9c:	40b005bb          	negw	a1,a1
    neg = 1;
     da0:	4e05                	li	t3,1
    x = -xx;
     da2:	b751                	j	d26 <printint+0x18>

0000000000000da4 <vprintf>:
}
...
{
     da4:	711d                	addi	sp,sp,-96
     da6:	ec86                	sd	ra,88(sp)
     da8:	e8a2                	sd	s0,80(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     dae:	0005c483          	lbu	s1,0(a1)
     db2:	26048663          	beqz	s1,101e <vprintf+0x27a>
     db6:	e0ca                	sd	s2,64(sp)
     db8:	fc4e                	sd	s3,56(sp)
     dba:	f852                	sd	s4,48(sp)
     dbc:	f456                	sd	s5,40(sp)
     dbe:	f05a                	sd	s6,32(sp)
     dc0:	ec5e                	sd	s7,24(sp)
     dc2:	e862                	sd	s8,16(sp)
     dc4:	e466                	sd	s9,8(sp)
     dc6:	8b2a                	mv	s6,a0
     dc8:	8a2e                	mv	s4,a1
     dca:	8bb2                	mv	s7,a2
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dda:	06c00c93          	li	s9,108
     dde:	a00d                	j	e00 <vprintf+0x5c>
        putc(fd, c0);
     de0:	85a6                	mv	a1,s1
     de2:	855a                	mv	a0,s6
     de4:	f0dff0ef          	jal	cf0 <putc>
     de8:	a019                	j	dee <vprintf+0x4a>
    } else if(state == '%'){
     dea:	03598363          	beq	s3,s5,e10 <vprintf+0x6c>
  for(i = 0; fmt[i]; i++){
     dee:	0019079b          	addiw	a5,s2,1
     df2:	893e                	mv	s2,a5
     df4:	873e                	mv	a4,a5
     df6:	97d2                	add	a5,a5,s4
     df8:	0007c483          	lbu	s1,0(a5)
     dfc:	20048963          	beqz	s1,100e <vprintf+0x26a>
    c0 = fmt[i] & 0xff;
     e00:	0004879b          	sext.w	a5,s1
    if(state == 0){
     e04:	fe0993e3          	bnez	s3,dea <vprintf+0x46>
      if(c0 == '%'){
     e08:	fd579ce3          	bne	a5,s5,de0 <vprintf+0x3c>
        state = '%';
     e0c:	89be                	mv	s3,a5
     e0e:	b7c5                	j	dee <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     ...
     e18:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e1a:	c681                	beqz	a3,e22 <vprintf+0x7e>
     e1c:	9752                	add	a4,a4,s4
     e1e:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e22:	03878e63          	beq	a5,s8,e5e <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
     e26:	05978863          	beq	a5,s9,e76 <vprintf+0xd2>
     ...
     e2e:	0ee78263          	beq	a5,a4,f12 <vprintf+0x16e>
     ...
     e36:	12e78463          	beq	a5,a4,f5e <vprintf+0x1ba>
     ...
     e3e:	14e78963          	beq	a5,a4,f90 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     e42:	07300713          	li	a4,115
     e46:	18e78863          	beq	a5,a4,fd6 <vprintf+0x232>
     ...
     e4e:	04e79463          	bne	a5,a4,e96 <vprintf+0xf2>
        putc(fd, '%');
     e52:	85ba                	mv	a1,a4
     e54:	855a                	mv	a0,s6
     e56:	e9bff0ef          	jal	cf0 <putc>
     ...
     e6a:	855a                	mv	a0,s6
     e6c:	ea3ff0ef          	jal	d0e <printint>
     e70:	8ba6                	mv	s7,s1
      state = 0;
     e72:	4981                	li	s3,0
     e74:	bfad                	j	dee <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     e76:	06400793          	li	a5,100
     e7a:	02f68963          	beq	a3,a5,eac <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e7e:	06c00793          	li	a5,108
     e82:	04f68263          	beq	a3,a5,ec6 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
     e86:	07500793          	li	a5,117
     e8a:	0af68063          	beq	a3,a5,f2a <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
     e8e:	07800793          	li	a5,120
     e92:	0ef68263          	beq	a3,a5,f76 <vprintf+0x1d2>
        putc(fd, '%');
     e96:	02500593          	li	a1,37
     e9a:	855a                	mv	a0,s6
     e9c:	e55ff0ef          	jal	cf0 <putc>
        putc(fd, c0);
     ea0:	85a6                	mv	a1,s1
     ea2:	855a                	mv	a0,s6
     ea4:	e4dff0ef          	jal	cf0 <putc>
      state = 0;
     ea8:	4981                	li	s3,0
     eaa:	b791                	j	dee <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     ec2:	4981                	li	s3,0
        i += 1;
     ec4:	b72d                	j	dee <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     ec6:	06400793          	li	a5,100
     eca:	02f60763          	beq	a2,a5,ef8 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     ece:	07500793          	li	a5,117
     ed2:	06f60963          	beq	a2,a5,f44 <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     ed6:	07800793          	li	a5,120
     eda:	faf61ee3          	bne	a2,a5,e96 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
  ...
  putc(fd, '0');
     ...
     f9e:	855a                	mv	a0,s6
     fa0:	d51ff0ef          	jal	cf0 <putc>
  putc(fd, 'x');
     fa4:	07800593          	li	a1,120
     fa8:	855a                	mv	a0,s6
     faa:	d47ff0ef          	jal	cf0 <putc>
     fae:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fb0:	00000b97          	auipc	s7,0x0
     fb4:	5c0b8b93          	addi	s7,s7,1472 # 1570 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     fca:	34fd                	addiw	s1,s1,-1
     fcc:	f4f5                	bnez	s1,fb8 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
     fce:	8bea                	mv	s7,s10
      state = 0;
     fd0:	4981                	li	s3,0
     fd2:	6d02                	ld	s10,0(sp)
     fd4:	bd29                	j	dee <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     fd6:	008b8993          	addi	s3,s7,8
     fda:	000bb483          	ld	s1,0(s7)
     fde:	cc91                	beqz	s1,ffa <vprintf+0x256>
        for(; *s; s++)
     fe0:	0004c583          	lbu	a1,0(s1)
     fe4:	c195                	beqz	a1,1008 <vprintf+0x264>
          putc(fd, *s);
     fe6:	855a                	mv	a0,s6
     fe8:	d09ff0ef          	jal	cf0 <putc>
        for(; *s; s++)
     fec:	0485                	addi	s1,s1,1
     fee:	0004c583          	lbu	a1,0(s1)
     ff2:	f9f5                	bnez	a1,fe6 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
     ff4:	8bce                	mv	s7,s3
      state = 0;
     ff6:	4981                	li	s3,0
     ff8:	bbdd                	j	dee <vprintf+0x4a>
          s = "(null)";
     ffa:	00000497          	auipc	s1,0x0
     ffe:	50e48493          	addi	s1,s1,1294 # 1508 <malloc+0x3fe>
        for(; *s; s++)
    1002:	02800593          	li	a1,40
    1006:	b7c5                	j	fe6 <vprintf+0x242>
        if((s = va_arg(ap, char*)) == 0)
    1008:	8bce                	mv	s7,s3
      state = 0;
    100a:	4981                	li	s3,0
    100c:	b3cd                	j	dee <vprintf+0x4a>
    ...
    101a:	6c42                	ld	s8,16(sp)
    101c:	6ca2                	ld	s9,8(sp)
    }
  }
}
...
0000000000001028 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1028:	715d                	addi	sp,sp,-80
    102a:	ec06                	sd	ra,24(sp)
    102c:	e822                	sd	s0,16(sp)
    102e:	1000                	addi	s0,sp,32
    1030:	e010                	sd	a2,0(s0)
    1032:	e414                	sd	a3,8(s0)
    1034:	e818                	sd	a4,16(s0)
    1036:	ec1c                	sd	a5,24(s0)
    1038:	03043023          	sd	a6,32(s0)
    103c:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    1046:	d5fff0ef          	jal	da4 <vprintf>
}
    104a:	60e2                	ld	ra,24(sp)
    104c:	6442                	ld	s0,16(sp)
    104e:	6161                	addi	sp,sp,80
    1050:	8082                	ret

0000000000001052 <printf>:

void
printf(const char *fmt, ...)
{
    1052:	711d                	addi	sp,sp,-96
    1054:	ec06                	sd	ra,24(sp)
    1056:	e822                	sd	s0,16(sp)
    1058:	1000                	addi	s0,sp,32
    105a:	e40c                	sd	a1,8(s0)
    105c:	e810                	sd	a2,16(s0)
    105e:	ec14                	sd	a3,24(s0)
    1060:	f018                	sd	a4,32(s0)
    1062:	f41c                	sd	a5,40(s0)
    1064:	03043823          	sd	a6,48(s0)
    1068:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    106c:	00840613          	addi	a2,s0,8
    1070:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1074:	85aa                	mv	a1,a0
    1076:	4505                	li	a0,1
    1078:	d2dff0ef          	jal	da4 <vprintf>
}
    107c:	60e2                	ld	ra,24(sp)
    107e:	6442                	ld	s0,16(sp)
    1080:	6125                	addi	sp,sp,96
    1082:	8082                	ret

0000000000001084 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  if(p + p->s.size == bp){
    ...
    10b4:	a091                	j	10f8 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10b6:	6398                	ld	a4,0(a5)
    10b8:	00e7e463          	bltu	a5,a4,10c0 <free+0x3c>
    10bc:	00e6ea63          	bltu	a3,a4,10d0 <free+0x4c>
{
    10c0:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10c2:	fed7fae3          	bgeu	a5,a3,10b6 <free+0x32>
    10c6:	6398                	ld	a4,0(a5)
    10c8:	00e6e463          	bltu	a3,a4,10d0 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10cc:	fee7eae3          	bltu	a5,a4,10c0 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    10d0:	ff852583          	lw	a1,-8(a0)
    10d4:	6390                	ld	a2,0(a5)
    10d6:	02059813          	slli	a6,a1,0x20
    10da:	01c85713          	srli	a4,a6,0x1c
    10de:	9736                	add	a4,a4,a3
    10e0:	fae60de3          	beq	a2,a4,109a <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
    10e4:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    10e8:	4790                	lw	a2,8(a5)
    10ea:	02061593          	slli	a1,a2,0x20
    10ee:	01c5d713          	srli	a4,a1,0x1c
    10f2:	973e                	add	a4,a4,a5
    10f4:	fae68ae3          	beq	a3,a4,10a8 <free+0x24>
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    1102:	60a2                	ld	ra,8(sp)
    1104:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1116:	02051993          	slli	s3,a0,0x20
    111a:	0209d993          	srli	s3,s3,0x20
    111e:	09bd                	addi	s3,s3,15
    1120:	0049d993          	srli	s3,s3,0x4
    1124:	2985                	addiw	s3,s3,1
    1126:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    1128:	00001517          	auipc	a0,0x1
    112c:	ee853503          	ld	a0,-280(a0) # 2010 <freep>
    1130:	c905                	beqz	a0,1160 <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1136:	09377663          	bgeu	a4,s3,11c2 <malloc+0xb8>
  ...
  if(nu < 4096)
    1142:	8a4e                	mv	s4,s3
    1144:	6705                	lui	a4,0x1
    1146:	00e9f363          	bgeu	s3,a4,114c <malloc+0x42>
    114a:	6a05                	lui	s4,0x1
    114c:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1150:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1154:	00001497          	auipc	s1,0x1
    1158:	ebc48493          	addi	s1,s1,-324 # 2010 <freep>
  if(p == (char*)-1)
    115c:	5afd                	li	s5,-1
    115e:	a83d                	j	119c <malloc+0x92>
    ...
    116c:	2a078793          	addi	a5,a5,672 # 2408 <base>
    ...
    if(p->s.size >= nunits){
    117e:	b7d1                	j	1142 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    1180:	6398                	ld	a4,0(a5)
    1182:	e118                	sd	a4,0(a0)
    1184:	a899                	j	11da <malloc+0xd0>
  hp->s.size = nu;
    1186:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    118a:	0541                	addi	a0,a0,16
    118c:	ef9ff0ef          	jal	1084 <free>
  return freep;
    1190:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    1192:	c125                	beqz	a0,11f2 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1194:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1196:	4798                	lw	a4,8(a5)
    1198:	03277163          	bgeu	a4,s2,11ba <malloc+0xb0>
    if(p == freep)
    119c:	6098                	ld	a4,0(s1)
    119e:	853e                	mv	a0,a5
    11a0:	fef71ae3          	bne	a4,a5,1194 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    11a4:	8552                	mv	a0,s4
    11a6:	b03ff0ef          	jal	ca8 <sbrk>
  if(p == (char*)-1)
    11aa:	fd551ee3          	bne	a0,s5,1186 <malloc+0x7c>
        return 0;
    11ae:	4501                	li	a0,0
    ...
    11b8:	a03d                	j	11e6 <malloc+0xdc>
    11ba:	74a2                	ld	s1,40(sp)
    11bc:	6a42                	ld	s4,16(sp)
    11be:	6aa2                	ld	s5,8(sp)
    11c0:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    11c2:	fae90fe3          	beq	s2,a4,1180 <malloc+0x76>
        p->s.size -= nunits;
    11c6:	4137073b          	subw	a4,a4,s3
    11ca:	c798                	sw	a4,8(a5)
        p += p->s.size;
    11cc:	02071693          	slli	a3,a4,0x20
    11d0:	01c6d713          	srli	a4,a3,0x1c
    11d4:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    11d6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    11da:	00001717          	auipc	a4,0x1
    11de:	e2a73b23          	sd	a0,-458(a4) # 2010 <freep>
      return (void*)(p + 1);
    11e2:	01078513          	addi	a0,a5,16
  }
}
    11e6:	70e2                	ld	ra,56(sp)
    11e8:	7442                	ld	s0,48(sp)
    11ea:	7902                	ld	s2,32(sp)
    11ec:	69e2                	ld	s3,24(sp)
