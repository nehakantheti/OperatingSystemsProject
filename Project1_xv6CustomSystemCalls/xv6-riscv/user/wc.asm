...
wc(int fd, char *name)
{
  ...
  3c:	988a0a13          	addi	s4,s4,-1656 # 9c0 <malloc+0xfe>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	94250513          	addi	a0,a0,-1726 # 9e0 <malloc+0x11e>
  ...
  cc:	90850513          	addi	a0,a0,-1784 # 9d0 <malloc+0x10e>
  d0:	73e000ef          	jal	80e <printf>
    exit(1);
  d4:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
 ...
 136:	89658593          	addi	a1,a1,-1898 # 9c8 <malloc+0x106>
 13a:	4501                	li	a0,0
 ...
 14e:	8a650513          	addi	a0,a0,-1882 # 9f0 <malloc+0x12e>
 152:	6bc000ef          	jal	80e <printf>
      exit(1);
 156:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d6:	53e50513          	addi	a0,a0,1342 # a10 <digits>
 4da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 76c:	2a8b8b93          	addi	s7,s7,680 # a10 <digits>
 ...
 7ba:	25290913          	addi	s2,s2,594 # a08 <malloc+0x146>
        for(; *s; s++)
