...
int main(int argc, char *argv[]) {
  ...
  18:	8f450513          	addi	a0,a0,-1804 # 908 <malloc+0x11a>
  1c:	388000ef          	jal	3a4 <forex>
    if (pid < 0) {
  ...
  2e:	90e50513          	addi	a0,a0,-1778 # 938 <malloc+0x14a>
  32:	704000ef          	jal	736 <printf>
    } else {
        wait(0);  // Parent process waits for the child
  ...
  42:	8d250513          	addi	a0,a0,-1838 # 910 <malloc+0x122>
  46:	6f0000ef          	jal	736 <printf>
        exit(1);
  4a:	4505                	li	a0,1
  4c:	2b8000ef          	jal	304 <exit>
        wait(0);  // Parent process waits for the child
  50:	4501                	li	a0,0
  52:	2ba000ef          	jal	30c <wait>
        printf("Parent process waited for exec child (PID: %d)\n", pid);
  56:	85a6                	mv	a1,s1
  58:	00001517          	auipc	a0,0x1
  5c:	91050513          	addi	a0,a0,-1776 # 968 <malloc+0x17a>
  60:	6d6000ef          	jal	736 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 416:	58e80813          	addi	a6,a6,1422 # 9a0 <digits>
 41a:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e2:	2ba48493          	addi	s1,s1,698 # 998 <malloc+0x1aa>
        for(; *s; s++)
