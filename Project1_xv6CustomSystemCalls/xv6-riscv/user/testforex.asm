...
user/_testforex:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
   ...
   c:	8c850513          	addi	a0,a0,-1848 # 8d0 <malloc+0x104>
  10:	708000ef          	jal	718 <printf>

    pid = forex("check");
  14:	00001517          	auipc	a0,0x1
  18:	8e450513          	addi	a0,a0,-1820 # 8f8 <malloc+0x12c>
  1c:	354000ef          	jal	370 <forex>
    if (pid < 0) {
  20:	00054e63          	bltz	a0,3c <main+0x3c>
  24:	e426                	sd	s1,8(sp)
  26:	84aa                	mv	s1,a0
  ...
  28:	e505                	bnez	a0,50 <main+0x50>
        printf("This line will not execute if exec succeeds.\n");
  2a:	00001517          	auipc	a0,0x1
  2e:	8fe50513          	addi	a0,a0,-1794 # 928 <malloc+0x15c>
  32:	6e6000ef          	jal	718 <printf>
    } else {
        wait(0);  // Parent process waits for the child
    ...
    exit(0);
  36:	4501                	li	a0,0
  38:	298000ef          	jal	2d0 <exit>
  3c:	e426                	sd	s1,8(sp)
        printf("forex failed with exec argument\n");
  3e:	00001517          	auipc	a0,0x1
  42:	8c250513          	addi	a0,a0,-1854 # 900 <malloc+0x134>
  46:	6d2000ef          	jal	718 <printf>
        exit(1);
  4a:	4505                	li	a0,1
  4c:	284000ef          	jal	2d0 <exit>
        wait(0);  // Parent process waits for the child
  50:	4501                	li	a0,0
  52:	286000ef          	jal	2d8 <wait>
        printf("Parent process waited for exec child (PID: %d)\n", pid);
  56:	85a6                	mv	a1,s1
  58:	00001517          	auipc	a0,0x1
  5c:	90050513          	addi	a0,a0,-1792 # 958 <malloc+0x18c>
  60:	6b8000ef          	jal	718 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e0:	5b450513          	addi	a0,a0,1460 # 990 <digits>
 3e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 676:	31eb8b93          	addi	s7,s7,798 # 990 <digits>
 ...
 6c4:	2c890913          	addi	s2,s2,712 # 988 <malloc+0x1bc>
        for(; *s; s++)
